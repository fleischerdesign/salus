        ...
        <Card>
          ...
          <form onsubmit={save} class="flex flex-col gap-4">
            ...
            <div class="flex justify-end">
              <Btn variant="primary" type="submit" size="md" loading={saving}
                >Parameter aktualisieren</Btn
              >
            </div>
          </form>
        </Card>
        ...
        <Card>
          ...
          <div class="space-y-3">
            <div class="grid grid-cols-2 gap-3">
              <div class="border-primary-200 bg-primary-50 rounded-lg border p-3 text-center">
                <p class="text-primary-600 text-xs font-medium">Target Window</p>
                <p class="text-primary-700 mt-1 text-base font-semibold">
