...
<div class="space-y-6">
    ...
    <div class="divide-y divide-surface-100">
      <div class="flex items-center justify-between px-5 py-4">
        <div>
          ...
          <p class="text-xs text-surface-400">
            Enhance security using standard TOTP authenticator apps.
          </p>
        </div>
      ...
      <div class="flex items-center justify-between px-5 py-4">
        <div>
          ...
          <p class="text-xs text-surface-400">
            Review recent login timestamps, IP locations, and API requests.
          </p>
        </div>
        <Badge variant="default">Coming Soon</Badge>
      </div>
  ...
  <Card>
    ...
    <p class="mb-4 text-sm text-surface-500">
      Under GDPR Article 20, you have the right to receive your data in a structured,
      machine-readable format. Export a complete ZIP archive of your health records and restore from
      a backup.
    </p>
    <div class="flex flex-wrap items-center gap-4">
      ...
      <div class="flex items-center gap-2">
        <input
          type="file"
          accept=".zip"
          class="text-sm text-surface-500 file:mr-3 file:rounded-md file:border file:border-surface-300 file:bg-surface-50 file:px-3 file:py-1.5 file:text-xs file:font-medium file:text-surface-700 hover:file:bg-surface-100"
        />
