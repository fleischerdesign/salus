  ...
  <div class="relative h-[120px] w-full pt-1 select-none sm:h-[135px]">
    ...
    >
      ...
      <div class="flex flex-col items-start text-left">
        <span class="mb-1 h-2 w-1 rounded-full bg-border-strong"></span>
        <span class="text-[0.6875rem] font-medium text-text-muted">
      ...
      <div class="hidden flex-col items-center sm:flex">
        <span class="mb-1 h-1.5 w-1.5 rounded-full bg-circadian"></span>
        <span class="text-[0.6875rem] font-bold text-circadian"> 10:00 Peak Fokus </span>
      </div>

      <!-- 3. Caffeine Cutoff (Center-Right) -->
      <div class="flex flex-col items-center text-center">
        <span class="mb-1 h-1.5 w-1.5 rounded-full bg-activity"></span>
        <span class="text-[0.6875rem] font-bold text-activity">
