...
<button
  class="group hover:border-primary-300 hover:bg-primary-50 hover:text-primary-600 relative inline-flex items-center gap-1 rounded-full border border-surface-200 bg-surface-50 px-2 py-0.5 text-[10px] text-surface-500 transition-colors"
