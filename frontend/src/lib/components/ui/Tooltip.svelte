<script lang="ts">
  ...
  let bubbleClass = $derived(
    'absolute left-1/2 z-60 -translate-x-1/2 rounded px-2 py-1 text-xs font-medium text-surface-50 opacity-0 shadow-md transition-opacity duration-micro group-hover:opacity-100 bg-surface-900 whitespace-nowrap ' +
