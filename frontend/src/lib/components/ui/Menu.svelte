...
<div class="relative {extraClass}" bind:this={containerEl}>
  <button
    type="button"
    class="duration-micro focus:ring-primary-200 flex h-8 w-8 items-center justify-center rounded-md text-surface-400 transition-colors hover:bg-surface-100 hover:text-surface-700 focus:ring-2 focus:outline-none"
