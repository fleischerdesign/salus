...
export const ANATOMICAL_MUSCLE_MAPPING: Record<string, MuscleGroup> = {
  ...
  // Shoulders & Traps
  'shoulder-front-left': 'Schultern',
  'shoulder-front-right': 'Schultern',
  'shoulder-side-left': 'Schultern',
  'shoulder-side-right': 'Schultern',
  'deltoid-rear-left': 'Schultern',
  'deltoid-rear-right': 'Schultern',
  'traps-upper-left': 'Nacken',
  'traps-upper-right': 'Nacken',
  'traps-mid-left': 'Rücken',
  'traps-mid-right': 'Rücken',
  'traps-lower-left': 'Rücken',
  'traps-lower-right': 'Rücken',

  // Chest
  'chest-upper-left': 'Brust',
  'chest-upper-right': 'Brust',
  'chest-lower-left': 'Brust',
  'chest-lower-right': 'Brust',

  // Arms
  'biceps-left': 'Bizeps',
  'biceps-right': 'Bizeps',
  'triceps-long-left': 'Trizeps',
  'triceps-lateral-left': 'Trizeps',
  'triceps-long-right': 'Trizeps',
  'triceps-lateral-right': 'Trizeps',
  'forearm-left': 'Unterarme',
  'forearm-right': 'Unterarme',
  'forearm-flexors-left': 'Unterarme',
  'forearm-extensors-left': 'Unterarme',
  'forearm-flexors-right': 'Unterarme',
  'forearm-extensors-right': 'Unterarme',
  'elbow-left': 'Unterarme',
  'elbow-right': 'Unterarme',
  'hand-left': 'Unterarme',
  'hand-right': 'Unterarme',
  'hand-back-left': 'Unterarme',
  'hand-back-right': 'Unterarme',

  // Back
  'lats-upper-left': 'Rücken',
  'lats-mid-left': 'Rücken',
  'lats-lower-left': 'Rücken',
  'lats-upper-right': 'Rücken',
  'lats-mid-right': 'Rücken',
  'lats-lower-right': 'Rücken',
  'lower-back-erectors-left': 'Rücken',
  'lower-back-ql-left': 'Rücken',
  'lower-back-erectors-right': 'Rücken',
  'lower-back-ql-right': 'Rücken',
  spine: 'Rücken',

  // Core / Abs
  'abs-upper-left': 'Bauch',
  'abs-upper-right': 'Bauch',
  'abs-lower-left': 'Bauch',
  'abs-lower-right': 'Bauch',
  'serratus-anterior-left': 'Bauch',
  'serratus-anterior-right': 'Bauch',
  'obliques-left': 'Bauch',
  'obliques-right': 'Bauch',

  // Glutes
  'gluteus-medius-left': 'Gesäß',
  'gluteus-maximus-left': 'Gesäß',
  'gluteus-medius-right': 'Gesäß',
  'gluteus-maximus-right': 'Gesäß',

  // Legs
  'quads-left': 'Quadrizeps',
  'quads-right': 'Quadrizeps',
  'adductors-left': 'Quadrizeps',
  'adductors-right': 'Quadrizeps',
  'hip-flexor-left': 'Quadrizeps',
  'hip-flexor-right': 'Quadrizeps',
  'hamstrings-medial-left': 'Hamstrings',
  'hamstrings-lateral-left': 'Hamstrings',
  'hamstrings-medial-right': 'Hamstrings',
  'hamstrings-lateral-right': 'Hamstrings',
  'tibialis-anterior-left': 'Waden',
  'tibialis-anterior-right': 'Waden',
  'calves-gastroc-medial-left': 'Waden',
  'calves-gastroc-lateral-left': 'Waden',
  'calves-soleus-left': 'Waden',
  'calves-gastroc-medial-right': 'Waden',
  'calves-gastroc-lateral-right': 'Waden',
  'calves-soleus-right': 'Waden',
  'knee-left': 'Quadrizeps',
  'knee-right': 'Quadrizeps',
  'knee-back-left': 'Hamstrings',
  'knee-back-right': 'Hamstrings',
  'foot-left': 'Waden',
  'foot-right': 'Waden',
  'foot-back-left': 'Waden',
  'foot-back-right': 'Waden'
};

export const ANTERIOR_MUSCLES: AnatomicalMuscleDef[] = [
  {
    id: 'head',
    name: 'Head',
    group: 'Nacken',
...
export const POSTERIOR_MUSCLES: AnatomicalMuscleDef[] = [
  {
    id: 'head-back',
    name: 'Head (Posterior)',
    group: 'Nacken',
