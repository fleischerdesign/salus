    ...
    <section>
      <div class="mb-2 flex items-center gap-2">
        ...
        <button
          ...
          class="hover:border-primary-300 hover:bg-primary-50 hover:text-primary-700 ml-auto flex items-center gap-1 rounded-full border border-surface-200 px-2.5 py-1 text-xs font-semibold text-surface-600 transition-colors"
