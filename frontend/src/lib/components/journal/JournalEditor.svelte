...
>
  <div class="mb-3 flex flex-wrap items-center justify-between gap-2">
    <div>
      ...
      <p class="mt-0.5 text-xs text-[var(--text-muted)]">
        Tagesreflexion & psychobiometrische Notizen
      </p>
    </div>
  ...
  <div class="mb-3 flex gap-2 overflow-x-auto pb-1">
    <button
      ...
      class="cursor-pointer rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-surface-50)] px-3 py-1.5 text-xs whitespace-nowrap text-[var(--text-muted)] transition-colors hover:bg-[var(--bg-surface-100)] hover:text-[var(--text-main)]"
    >
  ...
  <div
    class="mt-2 flex items-center justify-between border-t border-[var(--border-subtle)] pt-2 text-xs text-[var(--text-muted)]"
  >
