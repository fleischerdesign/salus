...
export const WIDGET_CATALOG: {
  ...
  // ─── 0. LAYOUT & GRUPPEN ───
  {
    ...
    description:
      'Erstelle eine neue gruppierte Sektion mit individuellem Titel, Untertitel und Spalten-Raster (1–3 Spalten).',
    category: 'Layout',
    defaultSize: 'full',
...
export const DEFAULT_DASHBOARD_ITEMS: DashboardItem[] = [
  // 1. Zirkadianer 24h-Sonnenbogen (Standalone Hero Widget)
  {
    id: 'item_circadian',
    kind: 'widget',
    widget: {
  ...
  // 2. Tages-Status & Biometrische Ringe (Standalone Hero Widget)
  {
    id: 'item_hero_rings',
    kind: 'widget',
    widget: {
  ...
  // 3. Gruppe: Kardiovaskuläre Vitalwerte
  {
    ...
    group: {
      ...
      subtitle: 'Blutdruck (ESC 2024), Ruhepuls, HRV und Sauerstoffsättigung',
      icon: 'favorite',
      collapsed: false,
      columns: 3,
      widgets: [
        { id: 'w_bp', type: 'blood_pressure_dial', title: 'Arterieller Blutdruck', size: 'third' },
        { id: 'w_rhr', type: 'rhr_sparkline', title: 'Ruhepuls & HRV-Trend', size: 'third' },
        { id: 'w_spo2', type: 'spo2_vo2max', title: 'SpO2 & VO2max', size: 'third' }
      ]
    }
  },
  // 4. Gruppe: Stoffwechsel & Glukose
  {
    id: 'grp_metabolism',
    kind: 'group',
    group: {
      ...
      subtitle: 'Interstitielle CGM-Kurve, Time in Range und 16:8 Autophagie-Uhr',
      icon: 'science',
      collapsed: false,
      columns: 3,
      widgets: [
        { id: 'w_cgm', type: 'cgm_wave', title: 'Glukosekurve (CGM)', size: 'third' },
        { id: 'w_tir', type: 'time_in_range', title: 'Time in Range (70-140)', size: 'third' },
        { id: 'w_fast', type: 'fasting_transition', title: '16:8 Autophagie-Uhr', size: 'third' }
      ]
    }
  },
  // 5. Gruppe: Regeneration & ZNS
  {
    id: 'grp_recovery',
    kind: 'group',
    group: {
      id: 'grp_recovery',
      title: 'Erholung, Schlaf & Autonomes Nervensystem',
      subtitle: 'ZNS-Erholungsbatterie, Vagus-Balance und Schlafarchitektur',
      icon: 'bedtime',
      collapsed: false,
      columns: 3,
      widgets: [
        { id: 'w_rec', type: 'recovery_battery', title: 'ZNS-Erholung', size: 'third' },
        { id: 'w_ans', type: 'ans_balance', title: 'Autonome Balance', size: 'third' },
        { id: 'w_sleep', type: 'sleep_hypnogram', title: 'Schlaf-Hypnogramm', size: 'third' }
      ]
    }
  }
];
