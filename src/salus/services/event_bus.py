...
class EventBus(ABC):
    @abstractmethod
    def subscribe(self, user_id: int) -> AsyncGenerator[None, None]:
        ...
...
class InMemoryEventBus(EventBus):
    def __init__(self) -> None:
        self._subscribers: dict[int, list[asyncio.Queue[None]]] = {}

    async def subscribe(self, user_id: int) -> AsyncGenerator[None, None]:
