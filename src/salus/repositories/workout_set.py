...
from salus.models.workout import WorkoutSet, WorkoutSession
from salus.repositories.base import Repository
from salus.repositories.protocols import IWorkoutSetRepository


class WorkoutSetRepository(Repository[WorkoutSet], IWorkoutSetRepository):
    model = WorkoutSet
    ...
    def find_exercise_history(
        ...
        stmt = (
            ...
            .options(selectinload(WorkoutSet.session))  # type: ignore[arg-type]
